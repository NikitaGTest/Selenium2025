...
import org.testng.annotations.BeforeTest;
	...
	public class ExtentReportsTest {
		...
		public void config() {
			...
			extent.setSystemInfo("Tester", "Nikitaa");
	        System.out.println("ExtentReports configured successfully: " + path);
	...
	public void purchaseOrder() {
			...
			extent.createTest("purchase Order");
	        ...
	        Assert.assertTrue(successMsg.equalsIgnoreCase("Thankyou for the order."),"Doesnot Match");
